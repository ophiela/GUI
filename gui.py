...
style = Style(root)
style.configure('TButton', font='Nueva 16',foreground='maroon', padding=25)
...
ttk.Button(navigate, text = 'Clear').grid(padx = 15)
ttk.Button(navigate, text = 'Button').grid(padx = 15)
drawPad = Canvas(root)
